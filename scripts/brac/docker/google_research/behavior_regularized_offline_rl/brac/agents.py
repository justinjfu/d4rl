...
from behavior_regularized_offline_rl.brac import conv_bc_agent
...
from behavior_regularized_offline_rl.brac import conv_brac_primal_agent
from behavior_regularized_offline_rl.brac import sac_agent


AGENT_MODULES_DICT = {
    'bc': bc_agent,
    'conv_bc': conv_bc_agent,
    'bcq': bcq_agent,
    'sac': sac_agent,
    'brac_primal': brac_primal_agent,
    'conv_brac_primal': conv_brac_primal_agent,
